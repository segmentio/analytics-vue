...
1. [Sign up](https://app.segment.com/signup?ref=github&library=vue) with Segment and edit the snippet in [index.html](https://github.com/segmentio/analytics-vue/blob/master/public/index.html#L11) to replace `YOUR_WRITE_KEY` with your Segment **Write Key**.
...
To install Segment in your own app, paste the snippet below into the `head` tag of your site. Then, [sign up](https://app.segment.com/signup?ref=github&library=vue) with Segment and replace `YOUR_WRITE_KEY` in the snippet with your Segment project's **Write Key**.
